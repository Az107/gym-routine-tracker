...
export const RestTimer = forwardRef<RestTimerRef, RestTimerProps>(
  (
    {
      defaultDuration = 90,
      onComplete,
      ...
      <div className={cn("flex flex-col gap-4", className)}>
        {isTimerExpanded ? (
          <>
            ...
            <Dialog
              open={showCustomTimerDialog}
              onOpenChange={setShowCustomTimerDialog}
            >
              <DialogContent>
                <DialogHeader>
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="flex-1" onClick={handleCustomTimerSave}>
                    Set Timer
                  </Button>
                </div>
              </DialogContent>
